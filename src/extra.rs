...
pub fn unit_tests() {
    ...
    // Signed Certum-32 Unit Tests
    assert_eq!(c64::from(f32::consts::PI).bits, 0b0001100100100001111110110110000000000000000000000000000000000000);
    assert_eq!(c64::from(f64::consts::PI).bits, 0b0001100100100001111110110101010001000100001011010001100000000000);
    assert_eq!(f32::from(c64::from(0b00110010010000111111011011000000)), 3.1415927410125732421875f32);
    assert_eq!(f64::from(c64::from(0b00110010010000111111011010101001)), 3.141592653589793115997963468544185161590576171875);
